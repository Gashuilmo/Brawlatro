...
descriptions = {
    Back = {
            b_brawl_gadget_deck = {
                name = "{f:brawl_font}One Time Use",
                text ={
    ...
    Enhanced = {
            m_brawl_dirty = {
                name = "{f:brawl_font}Dirty Card",
                text = {
                    "{f:brawl_font}1.5 chips ? Stone already",
                    "{f:brawl_font}exists but like idk what to do",
                    "{f:brawl_font}with that idea tbh",
                },
            },
        },
    Joker = {
            ...
            j_brawl_chesterjoker = {
                name = "{f:brawl_font}What Will It Be",
                text = {
                "{f:brawl_font}Has a random chance to trigger",
                "{f:brawl_font}different effects when" ,
                "{f:brawl_font}scoring cards",
                },
            },
            j_brawl_surged = {
            ...
            j_brawl_activator = {
                name = "{f:brawl_font}Gadget Gadget Gadget !",
                text = {
            ...
            j_brawl_brazil = {
                name = "{f:brawl_font}Street Artist",
                text = {
    ...
    Tag = { 
        tag_brawl_gear_tag =  {
                name = "{f:brawl_font}Gear Tag",
                text = {
                    "{f:brawl_font}Gives a free",
                    "{C:blue,f:brawl_font}Gear Pack"
                },
            },
        },
    Other = {
			brawl_gadget_seal = {
                name = "{f:brawl_font}Gadget Seal",
                text = {
            ...
            brawl_tooltip_click ={
                name = "{f:brawl_font}Click mechanic",
                text = {
                    "{f:brawl_font}Click this card to activate it's effect",
                    "{f:brawl_font}The Joker sprite will change to indicate",
                    "{f:brawl_font}if the effect is ready to be used",
                },
            },
            brawl_tooltip_brawler ={
                name = "{f:brawl_font}Brawler Joker",
                text = {
                    "{f:brawl_font}Joker themed around a Brawler",
                    "{f:brawl_font}from {C:money,f:brawl_font}Brawl Stars{}"
                },
            },
            p_brawl_megabox_b ={
            ...
            undiscovered_gear = {
                ...
                text = { 
                    "{f:brawl_font}Obtain this card to discover it" },
            },
        },
    Voucher = {
            v_brawl_brawlpass = {
    ...
    Tarot = {
        c_brawl_jujucurse = {
                name = "{f:brawl_font}Curse Of Juju",
                text={
                    "{f:brawl_font}The curse of Juju may be rewarding ",
                    "{f:brawl_font}Or not !",
                    "{C:inactive,f:brawl_font}(Must have room to spawn Gris-Gris){}",
                },
            },
        c_brawl_trunk = {
    ...
    misc = {
		...
		achievement_descriptions = {
			ach_brawl_power_12 = "Have Surge reach a Mult. of 12",
